...
import static com.softropic.sendam.security.contract.exception.SecurityError.FAULTY_JWT_ROLES_CLAIMS;
...
public class TokenCreatorImpl implements TokenCreator {
    ...
    private String getClientId(final boolean isLoggedIn) {
        ...
        throw new com.softropic.sendam.security.contract.exception.MissingClientIdException(msg);
    }
}
